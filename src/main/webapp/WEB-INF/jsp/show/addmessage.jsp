...
<div class="main-container">
	...
	<header class="header-section container-fluid no-padding">
		...
		<!-- 正文 -->
		<div class="infoDiv">
			<span class="usTitle">添加个人信息</span>
			<form action="/message/addmessage" method="post"><br><br>
				电话：<input type="text" name="tel" value="" ><br><br><br><br>
				地址：<input type="text" name="address" value=""  style="width:400px"><br><br><br><br>
				<input type="hidden" name="regAction" value="updateReg">
				<input type="submit" value="添加个人信息" class="setBut" onclick="return isNa()">
			</form>
		</div>
		
		<script type="text/javascript">
			function isNa(){
				if(document.getElementById("xinmin").value.length<=1 || 
					document.getElementById("danhua").value.length<=1 ||
					document.getElementById("dizi").value<=1 ){
					alert("添加个人信息不完整。");
					return false;
				}else{
					return true;
