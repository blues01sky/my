				 	...
				 	<c:otherwise>
						...
						<li class="product video">
							...
							<div class="wishlist-box">
								...
								<a href="chanpin/fenye"><i class="fa fa-search" title="更多相似产品"></i></a>
							</div>
							<a href="/cart1/cart2?shangpinming=${SearchResult.shangpinming}" class="addto-cart" title="添加到购物车">添加到购物车</a>
						</li><!-- Product /- -->
					</c:forEach>
				 	</c:otherwise>
				 </c:choose>
