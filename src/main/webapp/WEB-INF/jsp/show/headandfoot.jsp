...
<head>
	...
	<link rel="stylesheet" type="text/css" href="myorder_files/webcss.css">
...
<div class="main-container">
	...
	<!-- 正文 -->
		<div class="infoDiv">
			<span class="usTitle">我的订单</span>
			
			<table width="100%" border="0" cellpadding="0" cellspacing="0">
				<tbody><tr>
					<td width="3%" height="30" align="center"><b>序号</b></td>
					<td width="8%" align="center"><b>收货人姓名</b></td>
					<td width="10%" align="center"><b>联系电话</b></td>
					<td width="20%" align="center"><b>收货地址</b></td>
					<td width="10%" align="center"><b>快递名称</b></td>
					<td width="10%" align="center"><b>快递单号</b></td>
					<td width="8%" align="center"><b>合计金额</b></td>
					<td width="10%" align="center"><b>支付状态</b></td>
					<td width="10%" align="center"><b>订单时间</b></td>
					<td width="11%" align="center"><img src="./myorder_files/set.png"></td>
				</tr>
					...
					<tr>
						...
						<td width="5%" align="center">
							<a href="http://www.ggtxsc.com/reg/orderview.jsp?ddid=1556767311032">订单详情</a>
						</td>
					</tr>
