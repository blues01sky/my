...
<head>
	...
	<style>
		...
		ul.pagination li a:hover:not(.active) {background-color: #ddd;}
			...
			.lineInfo{display:block; line-height:84px; color:#003366; font-size:16px}
			.lineInfo i{color:#666; font-size:14px}
			.linkbut{display:inline-block; margin:50px 10px 0 0; width:120px; line-height:36px; background:#336699; text-align:center; color:#fff; }
...
<div class="main-container">
	...
	<c:choose>
		<c:when test="${ empty username}">
			<div class="infoDiv">
				<span class="usTitle">个人信息为空，请先添加个人信息！</span>
				<a href="" class="linkbut">添加个人信息</a>
			</div>
		</c:when>
			<c:otherwise>
				<div class="infoDiv">
					<span class="usTitle">我的收货信息</span>
					<span class="lineInfo"><i>姓名：</i>${message.getUsername()} </span>
					<span class="lineInfo"><i>电话：</i>${message.getTelphone() }</span>
					<span class="lineInfo"><i>地址：</i>${message.getAddress() }</span>
					<a href="/cart1/cart" class="linkbut" style="background:#ff4400">我的购物车</a>
					<a href="/message/myorder" class="linkbut" style="background:#ff4400">我的订单</a>
					<a href="/message/updatepdw" class="linkbut">修改密码</a>
					<a href="/message/updatemessage" class="linkbut">修改个人信息</a>
				</div>
			</c:otherwise>
	</c:choose>
