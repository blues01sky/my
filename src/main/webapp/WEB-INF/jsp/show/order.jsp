							...
							<div class="col-md-6 col-sm-12 col-xs-12">
								...
								<div class="billing-field">
									...
									<div class="col-md-12 form-group">
										<label>您的名字</label>
										<input class="form-control" placeholder="${message.username }" >
									</div><div class="col-md-12 form-group">
										<label>确认收货地址</label>
										<input class="form-control" placeholder="${message.address }" >
									</div>
									<div class="col-md-12 form-group">
										<label>确认联系电话</label>
										<input class="form-control" placeholder="${message.telphone }" >
									</div>
								</div>
							</div>
								...
								<div class="shipping-fields">
									<div class="checkout-order-table">
										<table>
											...
											<tbody>
												<c:forEach items="${findresults }" var="findresult">
												<tr class="cart_item">
													<td>商品：${findresult.goodsname}</td>
													<td>数量：${findresult.goodsnum}</td>
													<td>单价：${findresult.singleprice}</td>
												</tr>
												</c:forEach>
											</tbody>
											<tfoot>
									...
									<div class="checkout-payment">
										...
										<form action="/order/zhifu" method="post" >
