...
<div class="main-container">
	...
	<header class="header-section container-fluid no-padding">
		...
		<div class="infoDiv">
			...
			<form action="/message/updatemessage" method="post"><br><br>
				电话：<input type="text" id="dianhua" name="dianhua" value="" ><br><br><br><br>
				地址：<input type="text" id="dizhi" name="dizhi" value="" ><br><br><br><br>
				<input type="hidden" name="regAction" value="updateReg">
				<input type="submit" value="修改个人信息" class="setBut">
			</form>
		</div>
