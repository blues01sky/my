...
<div class="main-container">
	...
	<header class="header-section container-fluid no-padding">
		...
		<div class="infoDiv">
			...
			<form action="/message/updateusername" method="post"><br><br>
				新的用户名：<input type="text" id="yonghuming" name="yonghuming" value="" ><br><br><br><br>
				<input type="hidden" name="regAction" value="updateReg">
				<input type="submit" value="修改用户名" class="setBut" onclick="return isNa()">
			</form>
		</div>
